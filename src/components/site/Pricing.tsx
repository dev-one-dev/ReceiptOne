...
function AppleIcon({ isPopular }: { isPopular: boolean }) {
  return (
    <svg className="h-[14px] w-[14px] shrink-0" viewBox="0 0 24 24" fill={isPopular ? "black" : "white"} aria-hidden>
...
function GooglePlayIcon() {
  return (
    <svg className="h-[14px] w-[14px] shrink-0" viewBox="0 0 29.4 32" fill="none" aria-hidden>
