...
export function Pricing({ region = "ca" }: { region?: Region }) {
  ...
  return (
    <section
      id="pricing"
      className="w-full scroll-mt-28 px-4 pt-12 pb-12 sm:px-6 sm:pt-16 sm:pb-16 lg:px-8"
    >
      ...
      >
        ...
        {image && (
          <img
            ...
            loading="eager"
            decoding="async"
            className="pointer-events-none absolute bottom-0 -right-28 z-0 w-96 select-none object-contain sm:-right-32 sm:w-[26rem]"
          />
        )}
