          ...
          {FEATURES.map((f) => (
            ...
            >
              {"comingSoon" in f && f.comingSoon && (
                <span className="absolute top-0 left-1/2 z-20 -translate-x-1/2 -translate-y-1/2 whitespace-nowrap rounded-full bg-[#f97316] px-4 py-1 font-sans text-xs font-semibold text-black shadow-[0_4px_12px_rgba(249,115,22,0.4)]">
                  Coming soon
                </span>
              )}
