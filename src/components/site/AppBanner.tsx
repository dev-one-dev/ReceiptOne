...
function GooglePlayMark({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      <path
        fill="#FFD23D"
        d="m27.5 13.8-5.1-3L14.3 15v2l8.1 4.7 5.1-3c1.6-.9 1.6-3.1 0-4Z"
      />
      <path
        fill="#FF3A44"
      ...
      <path
        fill="#00F076"
        d="M14.3 15 4.8.8C4.3.4 3.7.2 3.1.2 2 .2 1 .6.3 1.3L14.3 15Z"
      />
    </svg>
  );
}
    ...
    <>
      <div className="flex flex-col gap-2 text-white">
        ...
        <p className="max-w-[520px] font-display text-base font-normal leading-6 text-[#A1A1A1]">
          ...
          accountant-ready reports in seconds.
        </p>
      </div>
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:gap-4">
        ...
        <div className="flex min-w-0 flex-col gap-2">
          ...
          <div className="flex flex-wrap items-center gap-4">
            ...
            >
              <span className="text-[8px] font-normal leading-tight text-black/70">
                GET IT ON
              </span>
...
export function AppBanner({ region = "ca" }: { region?: "ca" | "us" }) {
  ...
  if (region === "us" || region === "ca") {
    return (
      ...
      >
        <div className="mx-auto flex w-full max-w-[1440px] justify-center px-4 pt-1.5 pb-0 md:px-8 md:pt-2.5 md:pb-0">
          <a
            href={qrUrl}
            target="_blank"
            rel="noopener noreferrer"
