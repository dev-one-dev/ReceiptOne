...
export const Route = (createFileRoute as any)("/us/contact")({
  head: () => {
    const seo = pageSEO({
      path: "/us/contact",
      title: "Contact Us | ReceiptOne US",
      description:
        "Get in touch with the ReceiptOne team — questions, feedback, or support requests for US freelancers and small businesses.",
