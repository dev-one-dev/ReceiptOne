...
const SECTIONS: {
  number: string;
  title: string;
  subsections?: { id: string; title: string; region?: "us" | "ca" }[];
}[] = [
  { number: "1", title: "Scope" },
  {
    ...
    subsections: [
      ...
      {
        id: "2.6",
        title: "2.6 Categories of Personal Information for California Residents",
        region: "us",
      },
    ],
  },
  ...
  },
  {
    ...
    subsections: [
      ...
      {
        id: "9.2",
        title: "9.2 Express Consent for Quebec Residents and Sensitive Information",
        region: "ca",
      },
...
function PrivacyPage() {
  ...
  const { region, setRegion, openSections, setOpenSections, toggleSection } = useLegalUIState(
    "legal:privacy",
    allPartIds,
  );
  ...
  const allSectionAnchors = useMemo(
    () =>
      SECTIONS.flatMap((s) => [
        sectionAnchorId(s.number),
        ...(s.subsections?.map((ss) => subsectionAnchorId(ss.id)) ?? []),
      ]),
    [],
  );
  ...
  const scrollToId = (id: string) => {
    setOpenSections((prev) => {
      ...
      const parent = SECTIONS.find((s) =>
        s.subsections?.some((ss) => subsectionAnchorId(ss.id) === id),
      );
      ...
      <article className="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8 lg:py-12">
        <header className="border-b border-border pb-8">
          ...
          <div className="mt-6 max-w-3xl space-y-4 text-base leading-7 text-muted-foreground">
            <p>
              This Privacy Policy explains how ReceiptOne (&quot;ReceiptOne,&quot; &quot;we,&quot;
              &quot;us,&quot; or &quot;our&quot;) collects, uses, discloses, stores, and protects
              personal information when you use the ReceiptOne mobile applications (iOS and
              Android), the ReceiptOne web application, and related services (collectively, the
              &quot;Services&quot;).
            </p>
            <p>
              ReceiptOne is designed for self-employed individuals, contractors, and small
              businesses.
            </p>
            <p>
              This Privacy Policy is intended to comply with applicable privacy laws in Canada and
          ...
          <p className="mt-6 text-sm text-muted-foreground">
            ...
            <a
              ...
              href="mailto:support@receipt-one.com"
            >
        ...
        <div className="grid gap-10 py-10 lg:grid-cols-[240px_minmax(0,1fr)_280px] lg:gap-10">
          ...
          <PrivacyContext.Provider value={{ region, openSections, toggleSection }}>
            <div className="space-y-4">
              <Section number="1" title="Scope">
                <p>
                  This Privacy Policy applies to personal information collected through the
              ...
              <Section number="2" title="Information We Collect">
                ...
                <SubSection title="2.2 Receipt, Expense, and Tax-Related Data">
                  <p>
                    To provide expense tracking, organization, and reporting functionality, we may
                    collect and process:
                  </p>
                  <BulletList
                    items={[
                  ...
                  />
                  <p>
                    <strong>Sensitive personal information:</strong> Receipt images, expense
                    records, and uploaded documents may contain financial information and other
                    sensitive business information. We process this information only as reasonably
                    necessary to provide, secure, maintain, and improve the Services and for other
                ...
                <SubSection title="2.3 Payment Information">
                  <p>
                    ReceiptOne does not collect or store full payment card numbers through the
                    mobile application.
                  </p>
                  <p>
                    Payments for mobile subscriptions are processed by third-party platforms such as
                    Apple App Store and Google Play Store. We receive limited subscription metadata
                  ...
                  />
                  <p>
                    If additional web billing or payment processors are introduced in the future,
                ...
                <SubSection title="2.5 Device Permissions">
                  <DataTable
                    ...
                    rows={[
                      [
                        "Camera",
                        "Capture receipt or document images when you initiate a scan",
                        "Yes",
                      ],
                      [
                        "Photo Library / Storage",
                        "Select files or images that you choose to upload",
                        "Yes",
                      ],
                      [
                        "Push Notifications",
                        "Send service-related reminders, alerts, and updates",
                        "Yes",
                      ],
                    ]}
                  />
                  <p>
                    You may revoke device permissions through your device settings. If you do so,
                ...
                <SubSection title="2.6 Categories of Personal Information for California Residents">
                  <p>
                    For purposes of the CCPA/CPRA, we may collect the following categories of
                  ...
                  <DataTable
                    ...
                    rows={[
                      [
                        "Identifiers",
                        "Name, email address, account identifiers, device-related identifiers",
                      ],
                  ...
                  />
                  <p>
                    We do not use sensitive personal information to infer characteristics about
                    individuals. We use it only for limited purposes reasonably necessary to provide
                    the Services, maintain security, detect errors or fraud, comply with law, and
                    perform other permitted business purposes.
                  </p>
                </SubSection>
              </Section>
              ...
              <Section number="3" title="How We Use Personal Information">
                ...
                />
                <p>
                  Where permitted by law, we may also use de-identified or aggregated information
                  for analytics, research, service improvement, and business operations.
                </p>
                <p>
                  <strong>Important:</strong> ReceiptOne provides organizational and informational
                  tools only and does not provide legal, accounting, tax, or financial advice.
                </p>
              </Section>
              ...
              <Section number="4" title="AI-Assisted and Automated Processing">
                ...
                />
                <p>
                  <strong>Limitations of AI processing:</strong>
                </p>
                <BulletList
                  items={[
              ...
              <Section number="5" title="How We Share Personal Information">
                ...
                <p>
                  We may disclose personal information to the following categories of recipients for
                ...
                <DataTable
                  ...
                  rows={[
                    [
                      ...
                      "Authentication, storage, database, cloud functions, messaging, remote config",
                    ],
                    ...
                    [
                      "Logo.dev (Simple Casual, LLC)",
                      "Retrieval of merchant logo assets based on merchant domain information",
                    ],
                  ]}
                />
                <p>
                  We instruct all service providers to process personal information on our behalf
                  and for limited purposes related to providing and supporting the Services, subject
                  to applicable contracts, confidentiality obligations, and security requirements.
                </p>
                <p>
                  <strong>Corporate transactions:</strong> We may also disclose personal information
                  in connection with a merger, financing, acquisition, reorganization, sale of
                  assets, bankruptcy, or similar corporate transaction, subject to appropriate
              ...
              <Section number="6" title="International and Cross-Border Processing">
                <p>
                  ReceiptOne uses service providers and cloud-based infrastructure that may process
                  or store personal information in:
                </p>
                <BulletList
                  items={[
                    "Canada",
                ...
                />
                <p>
                  <strong>Legal implications:</strong> As a result, personal information may be
                  subject to the laws of those jurisdictions, including lawful access requests by
                  courts, regulators, or law enforcement authorities (for example, under the U.S.
                  CLOUD Act or equivalent Canadian legislation).
                </p>
                <p>
                  We use contractual, technical, and organizational safeguards that are appropriate
                  to the sensitivity of the information and the nature of the processing, including
              ...
              <Section number="7" title="Data Retention">
                <p>
                  ...
                  purposes described in this Privacy Policy, including to provide the Services and
                  comply with legal, accounting, tax, security, dispute resolution, and enforcement
                  obligations.
                </p>
                <p>
                ...
                <DataTable
                  ...
                  rows={[
                    [
                      "Account information",
                      "While account is active + reasonable period thereafter for legal/security purposes",
                    ],
                    [
                    ...
                    [
                      ...
                      "Reasonable period to manage support history, disputes, and service quality",
                    ],
                    [
                    ...
                    [
                      "Backup copies",
                      "Limited period according to backup, disaster recovery, and record management processes",
                    ],
                  ]}
                />
                <p>
                  <strong>Important note regarding service provider caching:</strong> Despite
                  deletion from our active systems, our service providers (including Google Cloud
                  and OpenAI) may retain hashed, logged, or cached copies of data for a limited
                  period (typically up to 30 days) for security, abuse prevention, and fraud
                  detection purposes. This is permitted under their respective terms of service and
                  applicable law. After such period, residual copies are deleted or rendered
                  unreadable.
                </p>
              </Section>
              ...
              <Section number="8" title="Your Privacy Rights">
                ...
                <SubSection title="8.2 United States (California and other states)">
                  <p>
                    Depending on your state of residence and subject to applicable exceptions, you
                  ...
                  />
                  <p>
                    Because ReceiptOne does not sell personal information or share personal
                    information for cross-context behavioral advertising, we do not offer a &quot;Do
                    Not Sell or Share&quot; mechanism for activities that we do not engage in.
                  </p>
                </SubSection>
                ...
                <SubSection title="8.3 How to Submit Requests">
                  ...
                  />
                  <p>
                    <strong>Authorized agents:</strong> Where required by law, authorized agents may
                    submit requests on behalf of individuals, subject to appropriate verification
                ...
                <SubSection title="8.4 Verification and Appeals">
                  <p>
                    <strong>Verification process:</strong> To protect your personal information, we
                    will verify your identity before fulfilling a request. Verification may include:
                  </p>
                  <BulletList
                    items={[
                  ...
                  />
                  <p>
                    If we cannot verify your identity or authority to act, we may deny or limit the
                    request as permitted by law.
                  </p>
                  <p>
                    <strong>Appeals process:</strong> If we deny a request, we will provide you
                    with:
                  </p>
                  <BulletList
                    items={[
                  ...
                  />
                  <p>
                    To appeal, please reply to our denial notice or contact us at
                    support@receipt-one.com with &quot;Appeal&quot; in the subject line.
                  </p>
                  <p>
                    <strong>Response timing:</strong> We will respond to verified requests within
                    the timeframes required by applicable law (typically 30 days for PIPEDA, 45 days
                    for CCPA/CPRA, with possible extensions where permitted).
                  </p>
                </SubSection>
              </Section>
              ...
              <Section number="9" title="Consent">
                <SubSection title="9.1 General Consent">
                  <p>
                    By creating an account, uploading receipts or documents, enabling optional
                    features, or otherwise using the Services, you consent to the collection, use,
                    and disclosure of personal information as described in this Privacy Policy,
                ...
                <SubSection title="9.2 Express Consent for Quebec Residents and Sensitive Information">
                  <p>
                    <strong>For residents of Quebec (Canada):</strong> Where required by
                    Quebec&apos;s Law 25, we obtain <strong>express consent</strong> before
                    collecting, using, or disclosing your personal information.
                  </p>
                  <p>
                    <strong>For sensitive personal information (all users):</strong> Where required
                    by applicable law (including CPRA for sensitive personal information), we obtain{" "}
                    <strong>express consent</strong> before collecting, using, or disclosing
                    financial or expense-related data contained in receipts, reports, and uploaded
                    documents.
                  </p>
                  <p>
                    <strong>How express consent is obtained:</strong> Express consent is obtained
                    when you:
                  </p>
                  <BulletList
                    items={[
                  ...
                  />
                  <p>
                    You may withdraw express consent at any time by contacting us. If you withdraw
                    consent for processing that is necessary to provide the Services, some features
                    or the Services themselves may no longer be available.
                  </p>
                </SubSection>
                ...
                <SubSection title="9.3 Withdrawal of Consent">
                  ...
                  />
                  <p>
                    If you withdraw consent for processing that is necessary to provide the
                    Services, some features or the Services themselves may no longer be available.
                  </p>
                </SubSection>
              </Section>
                ...
                <DataTable
                  ...
                  rows={[
                    [
                      ...
                      "TLS or similar protocols for all data transmitted over networks",
                    ],
                    ...
                    [
                      ...
                      "Reasonable steps to secure cloud environments (Firebase, Google Cloud)",
                    ],
                  ]}
                />
                <p>
                  <strong>Limitation:</strong> No method of transmission over the Internet or method
                  of electronic storage is completely secure. Accordingly, we cannot guarantee
                  absolute security. In the event of a data breach affecting your personal
                  information, we will notify you and relevant authorities as required by applicable
                  law.
                </p>
              </Section>
              ...
              <Section number="11" title="Children's Privacy">
                <p>
                  The Services are intended for adults and business users and are not directed to
                  children under the age of 18 (or the age of majority in your jurisdiction).
                </p>
                <p>
                  We do not knowingly collect personal information from children. If you believe a
                  child has provided personal information to us, please contact us immediately so
                  that we can review and delete such information.
                </p>
              </Section>
              ...
              <Section number="12" title="Changes to This Privacy Policy">
                ...
                />
                <p>
                  <strong>Notification of material changes:</strong>
                </p>
                <BulletList
                  items={[
              ...
              <Section number="13" title="Contact Information">
                <p>
                  <strong>Privacy Contact / Data Protection Officer (DPO) responsibilities</strong>{" "}
                  are handled by the ReceiptOne privacy team.
                </p>
                <p>
                  <strong>Email:</strong>{" "}
                  <a
                ...
                <div className="space-y-3">
                  <p>
                    <strong>Regulatory complaints (Canada):</strong> Office of the Privacy
                  ...
                  <p>
                    <strong>Regulatory complaints (Quebec):</strong> Commission d&apos;accès à
                ...
                <p className="text-sm text-muted-foreground">
                  © 2026 ReceiptOne. All rights reserved.
                </p>
              </Section>
            </div>
          ...
          <aside className="hidden lg:block">
            <div className="sticky top-24 max-h-[calc(100vh-7rem)] overflow-y-auto pr-1">
              <LegalSummary subtitle="Privacy Policy" items={PRIVACY_SUMMARY} region={region} />
            </div>
          </aside>
        </div>
      </article>
            ...
            <li key={s.number}>
              <div className="group flex items-start gap-1">
                ...
                <AnchorButton
                  hash={id}
                  region={region}
                  label={`Copy link to section ${s.number}`}
                />
              </div>
              {subs.length > 0 && (
      ...
      <div className="relative flex items-center gap-2 pr-3">
        ...
        >
          <div className="flex flex-1 items-baseline gap-3">
            ...
            <h2 className="font-display text-base font-semibold tracking-normal sm:text-lg">
              {title}
            </h2>
          </div>
          <ChevronDown
