 ...
 * Only ever returns a real, populated message or `fallback` -- never a
 * blank string (an empty `e.message` falls through to `fallback` rather
 * than being returned as-is) and never a raw stack trace.
 */
